...
// Modified PKC DATE 1-24-06 (changed 'F320.h to 'F326.h)
...
//	Include files
#include <c8051f326.h>		//	Header file for SiLabs c8051f326/7
...
void	Port_Init(void)
{  
   P2MDOUT	|=	0x0C;					//	Port 2 pins 2,3 set as push-pull outputs
}
